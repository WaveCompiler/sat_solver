...
class GWSAT:
    def __init__(self, num_vars, num_clauses, clauses, walk_prob):
    ...
    def solve(self, max_steps, max_tries):
        ...
        for try_idx in range(max_tries):
            ...
            for step in range(max_steps):
                ...
                random_walk =  random.random() < self.walk_prob
                if random_walk:
                    ...
                    # select one random var from the selected clause
...
if __name__ == "__main__":
    ...
    walk_solver = GWSAT(num_vars=num_vars, num_clauses=num_clauses, clauses=clauses, walk_prob=0.5)
